...
-- 사번, 직원면, 부서코드는 EMPLOYEE테이블에 조회가능
...
-- 4. 비등가 조인(NON EQUAL JOIN) - 공공기관에서 많이 사용
...
--> 다중 조인 시 앞에서 조인된 결과에 새로운 테이블 내용 조인
...
/*(LOCAL_CODE = 'L1' OR LOCAL_CODE = 'L2' OR LOCAL_CODE = 'L3')*/
