...
-- DUAL(DUmmy tbLe) 테이블 : 가짜 테이블(임시 조회용 데이블)
...
-- DISTINCT : 조회 시 컬럼에 포함된 중복 값은 한 번만 표기
...
ORDER BY 3 DESC; --SALARY가 3번째에 있어서
